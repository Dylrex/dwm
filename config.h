...
static const char *dmenucmd[] = { "j4-dmenu-desktop", "--display-bin", "--dmenu", "(cat ; (stest -flx $(echo $PATH | tr : ' ') | sort -u)) | dmenuwal" };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_BackSpace,	quit,		{.i = 23} },
	...
	{ 0, XF86XK_AudioMute,		spawn,		SHCMD("volchange volmute && pkill -RTMIN+10 dwmblocks") },
	{ 0, XF86XK_AudioRaiseVolume,	spawn,		SHCMD("volchange volup && pkill -RTMIN+10 dwmblocks") },
	{ 0, XF86XK_AudioLowerVolume,	spawn,		SHCMD("volchange voldown && pkill -RTMIN+10 dwmblocks") },
	{ ShiftMask, XF86XK_AudioMute,		spawn,		SHCMD("playerctl play-pause && pkill -RTMIN+11 dwmblocks") },
	{ ShiftMask, XF86XK_AudioRaiseVolume,	spawn,		SHCMD("playerctl next && pkill -RTMIN+11 dwmblocks") },
	{ ShiftMask, XF86XK_AudioLowerVolume,	spawn,		SHCMD("playerctl previous && pkill -RTMIN+11 dwmblocks") },
